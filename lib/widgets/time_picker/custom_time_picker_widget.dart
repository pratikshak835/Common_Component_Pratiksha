...
class _HourMinuteControl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle style =
        timePickerTheme.hourMinuteTextStyle ?? themeData.textTheme.titleMedium!;
...
class _StringFragment extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ExcludeSemantics(
      child: Padding(
        padding: const EdgeInsets.only(left: 6.0, right: 6.0, bottom: 22.0),
        child: Center(
          child: Text(
...
class _TimePickerInputState extends State<_TimePickerInput>
  ...
  Widget build(BuildContext context) {
    ...
    final ThemeData theme = Theme.of(context);
    final TextStyle? hourMinuteStyle =
        TimePickerTheme.of(context).hourMinuteTextStyle ?? theme.textTheme.titleMedium;
          ...
          children: [
            InkWell(
              ...
              child: Container(
                ...
                child: const Center(child: CustomText(text: "Cancel")),
              ),
            ),
            SizedBox(width: 16),
            InkWell(
